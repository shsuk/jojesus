...
<uf:organism >
[
	<job:db id="row" query="voj/intro/edit" singleRow="true"/>
]
</uf:organism>
...
<div  id="body_main">
	...
	<form id="content_form" action="sample.php" method="post" style="clear: both;">
		<input type="hidden" name="action" value="${empty(req.bd_id) && empty(req.bd_key) ? 'i' : 'u' }">
		...
		<table style="width: 100%;border:1px solid #B6B5DB;color:#002266;margin-bottom: 5px;">
			...
			<tr>
				<th width="55">아이디:</th>
				<td><input type="text" name="bd_key" id="bd_key" title="" style="width: 95%;" value="${row.bd_key }" valid="[['maxlen:10']]"></td>
			</tr>
		</table>
